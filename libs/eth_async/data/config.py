...
MODE_API_KEY = str(os.getenv('MODE_API_KEY'))
SONEIUM_API_KEY = str(os.getenv('SONEIUM_API_KEY'))
INK_API_KEY = str(os.getenv('INK_API_KEY'))
UNICHAIN_API_KEY = str(os.getenv('UNICHAIN_API_KEY'))
LISK_API_KEY = str(os.getenv('LISK_API_KEY'))
EXAMPLE_API_KEY = str(os.getenv(''))
